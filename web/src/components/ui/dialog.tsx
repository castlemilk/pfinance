    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Mobile: near-full-screen with small margin, scrollable
          "inset-2 max-h-[calc(100vh-1rem)] overflow-y-auto rounded-lg p-4",
          // Desktop: centered modal
          "sm:inset-auto sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:max-h-[85vh] sm:rounded-lg sm:p-6",
          className
        )}
        {...props}
      >
